...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number=PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+250788875240')
    ...
    country = CountryField(verbose_name=_('Country'), default='RW', blank=False, null=False)
    city = models.CharField(verbose_name=_('City'), max_length=180, default='Kigali', blank=False, null=False)
